...
- `SKILLS-20260522-001` — 新增：全部已安装技能知识库（迁移自 v1 结构）
- `SKILLS-20260522-002` — 新增：Skills 与 MCP 完整使用指南（含详细用法 + MCP 安装指南）
- `ARTICLE-20260522-001` — 新增：CodeGraph 预索引代码知识图谱
- `ARTICLE-20260522-002` — 新增：Chrome DevTools for Coding Agents
- Playwright MCP — 安装：浏览器自动化（Chromium 已下载）
...
- `INDEX.md` — 新增：主索引文件
- `KNOWLEDGE_GRAPH.md` — 新增：交叉引用关系图
- `CHANGELOG.md` — 新增：变更记录
- `README.md` — 重构：改为快速入口
- 目录结构重构：引入 `raw/` `compiled/` `archive/` 分层
